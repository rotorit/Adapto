...
Eventual plans are to implement the vertical X standard(http://reprap.org/wiki/Vertical_X_Axis_Standard) and lock the spacing permanently into the design. Example STLs have been provided to view the parts on github. Naming conventions have been shortened and standardized somewhat. the _x# is the amount of a given part that needs to be printed.
